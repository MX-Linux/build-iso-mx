...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=I386_EFI -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/12/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.06"
grub_package="grub"
grub_package_string="GRUB 2.06-12"
grub_package_version="2.06-12"
